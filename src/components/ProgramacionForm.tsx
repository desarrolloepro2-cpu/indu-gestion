...
import { X, AlertCircle, ChevronDown, Search, Check, User } from 'lucide-react';
...
// Reusable Searchable Select Component with Enhanced UI and Avatar Support
    ...
    <div className="input-group" style={{ position: 'relative' }} ref={dropdownRef}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', overflow: 'hidden' }}>
          ...
          {!selectedOption?.image && selectedOption && label.toLowerCase().includes('responsable') && (
              ...
              filteredOptions.map((opt: any) => (
                ...
                >
                  {opt.image ? (
                    ...
                    label.toLowerCase().includes('responsable') && (
